    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        <Text style={styles.labelCongratsText}>
          Hore! Kamu sudah menyelesaikan try out!
        </Text>
        <View
          style={[
      ...
      <View style={styles.bottomComponent}>
        <TouchableOpacity
          onPress={() => {
            navigation.navigate('StartTryOut', {
              tryoutId: tryOutDetailData?.data?.id,
            });
          }}
        ...
        >
          <Text>Kembali ke try out saya</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
