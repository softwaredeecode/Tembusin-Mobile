...
const LeaderboardTryoutPage = props => {
            ...
            rightComponent={
              <View style={styles.searchBarContainer}>
                <SearchBar
                  ...
                  placeholder={'Cari di leaderboard tryout...'}
                />
            ...
            ListEmptyComponent={
              !loadingLeaderboard && !isLoadingMore ? (
                <ListEmptyComponent
                  ...
                  desc={'Mulai eksplorasi dan akses tryout soal-mu'}
...
export default LeaderboardTryoutPage;
