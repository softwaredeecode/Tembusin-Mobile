...
const ExercisesResultPage = props => {
  ...
  const scoreMeta = getScoreMeta(resultData.total_score);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        <Text style={styles.labelCongratsText}>
          Hore! Kamu sudah menyelesaikan latihan soal!
        </Text>
        <View
          style={[
      ...
      <View style={styles.bottomComponent}>
        <TouchableOpacity
          onPress={() => {
            navigation.navigate('StartExercisesPage', {
              exercisesSetId: startNewAttemptData.data.practice_set_id,
            });
          }}
        ...
        >
          <Text>Kembali ke latihan soal saya</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
...
export default ExercisesResultPage;
