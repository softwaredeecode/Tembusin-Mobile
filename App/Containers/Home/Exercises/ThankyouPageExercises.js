...
const ThankyouPageExercises = props => {
  ...
  const accessId = exercisesSetDetailData?.data?.access_type?.id ?? null;
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          navigation.replace('StartExercisesPage', {
            exercisesSetId: exercisesSetDetailData.data.id,
          });
        }}
      >
...
export default ThankyouPageExercises;
