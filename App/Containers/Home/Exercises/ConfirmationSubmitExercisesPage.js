...
const ConfirmationSubmitExercisesPage = () => {
  ...
  console.log(exercisesSetDetailData, 'exercisesSetDetailData');
  console.log(startNewAttemptData, 'startNewAttemptData');

  const handleSubmitAttempt = async () => {
    setLoading(true);
    const token = await AsyncStorage.getItem('auth_token');
    const response = await ActionStudent.SubmitAttempt(
      token,
    ...
    if (response.data) {
      ...
      navigation.reset({
        ...
        routes: [
          { name: 'MainTabs' },
          { name: 'ExercisesPage' },
          { name: 'MyExercisesPage' },
          {
            name: 'ExercisesResultPage',
            params: {
              resultData: response.data,
              startNewAttemptData: startNewAttemptData,
            },
          },
        ],
      });
  ...
  return (
    <View style={styles.container}>
      ...
      <MainHeader
        title={exercisesSetDetailData.data.practice_set_name}
        showBack={false}
      />
...
export default ConfirmationSubmitExercisesPage;
